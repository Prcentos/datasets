...
class SplitsOffsetIntegrationTest(testing.TestCase):
  ...
  def test_sub_split(self):
    ...
    print(list(sorted(values_00_19)))
    print(list(sorted(values_20_39)))
    print(list(sorted(values_40_99)))
    print(len(values_00_19))
    print(len(values_20_39))
    print(len(values_40_99))
